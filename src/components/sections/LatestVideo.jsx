...
const LatestVideo = ({ videoId = "0TRzQCbaPzotUPiu1po7hr", showText = true }) => { // Placeholder ID or actual one if found
        ...
        <section className="py-24 relative overflow-hidden">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <motion.div
                    ...
                    className={`relative group ${showText ? 'mt-20' : ''}`}
                >
                    {/* Retro TV Frame Styling via CSS classes */}
                    <div 
                        className="relative aspect-video bg-black rounded-sm overflow-hidden border hover-glow shadow-2xl cursor-pointer"
                        style={{
